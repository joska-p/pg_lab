            ...
            <Card variant="raised">
                <ControlSection title="Mini Synth">
                    ...
                    <ColorField
                        label="tint"
                        value={synth.tint}
                        onValueChange={(tint) => onPatch({ tint })}
                    />
                    <Checkbox
                        label="glide"
                        checked={synth.glide}
                    ...
                    <Toggle
                        label="mute"
                        checked={synth.mute}
                        onCheckedChange={(mute) => onPatch({ mute })}
                    />
            ...
            <Stack direction="horizontal" gap="8" wrap>
                ...
                <Card variant="surface">
                    <ControlSection title="Text">
                        ...
                        <Text variant="muted">
                            Muted carries secondary information without competing.
                        </Text>
                    </ControlSection>
                </Card>
            </Stack>
        ...
        <Stage label="@repo/ui · component inventory">
            <Stack gap="16">
                <div {...stylex.props(leadStyles.container)}>
                    ...
                    <Text variant="muted">
                        Inventory of @repo/ui — components only, no raw values.
                    </Text>
                </div>
