...
export function JuliaDoubleSplitControls() {
    ...
    return (
        <>
            ...
            />
            <ControlSection title="Julia constant">
                <NumberField
                    label="c · real"
                    min={-2}
                    max={2}
                    ...
                    onValueChange={(value) => setParam('juliaRe', value)}
                />
                <NumberField
                    label="c · imaginary"
                    min={-2}
                    ...
                    onValueChange={(value) => setParam('juliaIm', value)}
                />
            </ControlSection>
