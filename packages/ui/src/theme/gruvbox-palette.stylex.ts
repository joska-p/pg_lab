...
/**
 * Palette Gruvbox brute — valeurs "raw" extraites de :
 * https://github.com/morhetz/gruvbox-contrib/blob/master/color.table
 *
 * Ce fichier ne contient QUE la palette (couleurs primitives, sans intention
 * sémantique). L'étape suivante consistera à créer des tokens sémantiques
 * (ex: colorBackgroundPrimary, colorTextMuted, colorAccentDanger, ...) via
 * `stylex.defineConsts`, en mappant sur ces valeurs, avec un thème light/dark.
 */

export const gruvboxPalette = stylex.defineConsts({
  // --- Dark backgrounds / dark foregrounds ---
  ...
  // --- Gray (identique dans les deux tables, gardé pour compat terminal) ---
  gray245: "oklch(0.619 0.029 67.258)",
  gray244: "oklch(0.619 0.029 67.258)",

  // --- Light backgrounds / light foregrounds ---
  ...
  // --- Bright accents (utilisés généralement sur fond dark) ---
  ...
  // --- Neutral accents (contraste intermédiaire) ---
  ...
  // --- Faded accents (utilisés généralement sur fond light) ---
