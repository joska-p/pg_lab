...
// Raw Gruvbox palette — verbatim values from:
// https://github.com/morhetz/gruvbox-contrib/blob/master/color.table
//
// This file holds ONLY the primitive palette (no semantic intent). Semantic
// tokens in `tokens/*` map onto these values. Components never import this
// file directly (One-Token Rule).
export const gruvboxPalette = stylex.defineConsts({
  ...
  // --- Gray (identical in both tables, kept for terminal compat) ---
  ...
  // --- Bright accents (usually on dark grounds) ---
  ...
  // --- Faded accents (usually on light grounds) ---
