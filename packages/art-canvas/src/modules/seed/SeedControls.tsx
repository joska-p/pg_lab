...
function SeedControls() {
  ...
  return (
    <>
      ...
      <Slider label="Complexity" value={complexity} onValueChange={setComplexity} min={1} max={5} />
      <Select<MoodName> label="Mood" value={mood} onValueChange={setMood} options={MOOD_OPTIONS} />
